...
public class RecommendRestController {
    ...
    @Operation(summary = "기업 문제추천 새로고침")
    @PostMapping("/company")
    ...
    @Operation(summary = "ai 문제추천 새로고침")
    @PostMapping("/ai")
