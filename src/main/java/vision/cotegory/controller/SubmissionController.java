...
public class SubmissionController {
    ...
    @GetMapping("/time")
    public ResponseEntity<List<SubmissionResponse>> timeSubmission(@RequestHeader(value = "Authorization")Member member, DateSubmissionRequest dateSubmissionRequest)
    {
    ...
    @PostMapping
    public void createSubmission(@RequestHeader(value = "Authorization") Member member, CreateSubmissionRequest createSubmissionRequest)
    {
    ...
    @GetMapping("/page")
    public ResponseEntity<SubmissionPageInfoResponse> pageInfo(@RequestHeader(value = "Authorization")Member member, SubmissionPageInfoRequest sr)
    {
